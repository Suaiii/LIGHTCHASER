...
> **⚠️ 7.18 v4 战略转向增补（母文档 [product-arch-v4.md](product-arch-v4.md)，取代 v3）**：产品收为**两轴**、**板块三滤镜摄影移出产品**（追光相机连不到抖音内容生产界面，P-3 裁定）。本任务再拆：
> - **06a-P1（目标 1，P1 前 5 秒违规修复）＝保留有效**——轴一钩子 feed 卡还在，前 5 秒仍是 30% 体验完整性主战场，且不再依赖 PR #29（相机部分归档，占用冲突消失，**可立即开工不必等 #29**）。
> - **06a-P4（目标 3，相机 HTTPS）＋ 06b（目标 2，P3 打磨）＝随板块三归档**，不进本期产品（作 product-arch-v4 §7 未来效果展示）。
> - 下方 7.15 拆单横幅中"先等 #29 合入再开工"的前置**对 06a-P1 已失效**（相机归档后无占用重叠）；DoD 中相机相关项（真机 P4 录屏、双端色彩）随 P4 归档，不再验收。
