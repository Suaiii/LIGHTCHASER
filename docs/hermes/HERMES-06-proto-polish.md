...
> ①本任务拆为 **06a＝目标 1（P1 前 5 秒）+ 目标 3（P4 HTTPS），立即有效**；**06b＝目标 2（P3 打磨），冻结待 D-b**——映射：**D-b=重排 → 06b 取消**（P3「社区」列并入地图气泡层由 HERMES-10 承接，无独立 P3 可打磨）；**D-b=不重排 → 06b 解冻**（P3 仍是独立列，照原任务书打磨）。
