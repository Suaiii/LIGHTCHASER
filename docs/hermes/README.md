...
7.23 **Gate 0**（弹药全齐）｜ 7.24 平台开放（HERMES-04 执行日）｜ 7.27 Gate 1（**唯一口径＝v4 两轴：钩子 feed 卡 + 地图实时社区（2D 招牌）**；AGENT_00 宪法"四页 60 秒"与旧"真机三板块"两种说法**均已作废**，见 7.20 裁定书 G-4）｜ 7.30 Gate 2 ｜ 7.31–8.2 深圳现场。
