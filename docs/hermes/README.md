...
| 原型 | GL 3D 招牌+气泡 | ✅ **已交付（7.24 补票，PR #39 修 F6）**；真机可行性判定挂 #19（R-0724-C：跑不动则 ripcord 回装 2D） | HERMES-11 |
| 原型 | ~~3D 光域高亮~~ | **取消（7.15 D-c）** | HERMES-03 |
| 原型 | 06a-P1 前 5 秒规格（随 09 包交付） | **已并入 09**（#21 已关，不修原型代码） | HERMES-06 |
| ~~原型~~ | ~~板块三滤镜摄影（PR#29 相机）~~ | **移出产品（P-3）→ 0724 挂死（R-0724-A：动不了、不回装）**，归档为未来效果展示 | product-arch-v4 §7 |
